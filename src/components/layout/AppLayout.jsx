...
const AppLayout = memo(function AppLayout() {
  ...
  return (
    <div className={cn('min-h-screen bg-background relative overflow-hidden selection:bg-primary/30', isRadar && 'min-h-0 h-screen')}>
      ...
      <main
        ...
        className={cn(
          isRadar
            ? 'fixed inset-0 z-0'
            : 'relative z-10 mx-auto max-w-2xl pb-24'
        )}
        role="main"
      >
        <Outlet />
