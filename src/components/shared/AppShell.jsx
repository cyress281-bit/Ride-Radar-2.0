...
/**
 * AppShell — Main application wrapper with electric neon background effects.
 *
      ...
      {!isRadar && (
        <>
          ...
          <div
            ...
            aria-hidden="true"
          />
          {/* Neon green radial glow — top left (very faint) */}
          <div
            className="fixed top-[-10%] left-[-10%] w-[45vw] h-[45vw] max-w-[400px] max-h-[400px] rounded-full bg-primary/[0.03] blur-3xl pointer-events-none"
            aria-hidden="true"
          />
          {/* Radar blue radial glow — bottom right (very faint) */}
          <div
            className="fixed bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] max-w-[450px] max-h-[450px] rounded-full bg-cyan/[0.025] blur-3xl pointer-events-none"
            aria-hidden="true"
          />
