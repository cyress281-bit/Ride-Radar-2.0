...
function ConversationSkeleton() {
  return (
    <div
      ...
      style={{
        height: 'calc(var(--rr-viewport-height, 100dvh) - 3.5rem - env(safe-area-inset-top, 0px) - max(0px, calc(3.5rem + var(--rr-safe-area-bottom, env(safe-area-inset-bottom, 0px)) - var(--rr-keyboard-height, 0px))))',
      }}
    >
