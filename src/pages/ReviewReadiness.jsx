...
export default function ReviewReadiness() {
  const rows = [
    ...
    ['Auth review note', 'Supabase handles authentication. Current public login options are email and Google. Apple and Facebook login are disabled until provider credentials are configured.'],
