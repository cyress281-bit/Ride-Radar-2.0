...
export default function ReviewReadiness() {
  const rows = [
    ...
    ['Auth review note', 'Supabase handles authentication. If third-party/social login is enabled for iOS, Sign in with Apple must remain enabled in the auth/provider configuration before App Store submission.'],
